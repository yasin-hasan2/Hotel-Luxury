  ...
  return (
    <div>
      <div className=" bg-gradient-to-r from-[#605d53] to-[#5d5640] h-60 flex justify-center items-center">
        <h1 className="text-6xl font-semibold text-white "> Contact With Us</h1>
      </div>
      <div className="lg:flex  my-10 justify-around  ">
        <div className=" lg:mt-10 lg:pl-10 text-textWhite">
          ...
          <span className="text-xl  ">Lets connect With US </span>
          <div className="flex mt-4 items-center  gap-3">
            <AiOutlineMail className=" text-yellow-400 hover:shadow-slate-400 shadow-lg rounded-xl text-3xl"></AiOutlineMail>
            <div>
              <h5>Mail me at</h5>
        ...
        <div>
          <h1 className="text-3xl flex mb-8">
            Send us a message{" "}
            <BsRocketTakeoffFill className="text-yellow-400"></BsRocketTakeoffFill>{" "}
          </h1>
          ...
          <button className="btn btn-outline  text-yellow-400 hover:btn-warning ">
            {" "}
            Send message{" "}
          </button>
        </div>
